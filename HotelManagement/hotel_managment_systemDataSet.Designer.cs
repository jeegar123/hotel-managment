...
namespace HotelManagement {
    ...
    public partial class hotel_managment_systemDataSet : global::System.Data.DataSet {
        ...
        public partial class reservationDataTable : global::System.Data.TypedTableBase<reservationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public reservationRow AddreservationRow(int room_number, int client_id, string room_type, System.DateTime date_in, System.DateTime date_out) {
...
namespace HotelManagement.hotel_managment_systemDataSetTableAdapters {
    ...
    public partial class reservationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[reservation] WHERE (([room_number] = @Original_room_number) AND ([reservation_id] = @Original_reservation_id) AND ([client_id] = @Original_client_id) AND ([room_type] = @Original_room_type) AND ([date_in] = @Original_date_in) AND ([date_out] = @Original_date_out))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[reservation] ([room_number], [client_id], [room_type], [date_in], [date_out]) VALUES (@room_number, @client_id, @room_type, @date_in, @date_out);
SELECT room_number, reservation_id, client_id, room_type, date_in, date_out FROM reservation WHERE (reservation_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[reservation] SET [room_number] = @room_number, [client_id] = @client_id, [room_type] = @room_type, [date_in] = @date_in, [date_out] = @date_out WHERE (([room_number] = @Original_room_number) AND ([reservation_id] = @Original_reservation_id) AND ([client_id] = @Original_client_id) AND ([room_type] = @Original_room_type) AND ([date_in] = @Original_date_in) AND ([date_out] = @Original_date_out));
SELECT room_number, reservation_id, client_id, room_type, date_in, date_out FROM reservation WHERE (reservation_id = @reservation_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HotelManagement.Properties.Settings.Default.hotel_managment_systemConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT room_number, reservation_id, client_id, room_type, date_in, date_out FROM " +
                "dbo.reservation";
        ...
        public virtual int Fill(hotel_managment_systemDataSet.reservationDataTable dataTable) {
        ...
        public virtual hotel_managment_systemDataSet.reservationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            hotel_managment_systemDataSet.reservationDataTable dataTable = new hotel_managment_systemDataSet.reservationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(hotel_managment_systemDataSet.reservationDataTable dataTable) {
        ...
        public virtual int Delete(int Original_room_number, int Original_reservation_id, int Original_client_id, string Original_room_type, System.DateTime Original_date_in, System.DateTime Original_date_out) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((System.DateTime)(Original_date_in));
            this.Adapter.DeleteCommand.Parameters[5].Value = ((System.DateTime)(Original_date_out));
        ...
        public virtual int Insert(int room_number, int client_id, string room_type, System.DateTime date_in, System.DateTime date_out) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((System.DateTime)(date_in));
        ...
        public virtual int Update(int room_number, int client_id, string room_type, System.DateTime date_in, System.DateTime date_out, int Original_room_number, int Original_reservation_id, int Original_client_id, string Original_room_type, System.DateTime Original_date_in, System.DateTime Original_date_out, int reservation_id) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((System.DateTime)(date_in));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int room_number, int client_id, string room_type, System.DateTime date_in, System.DateTime date_out, int Original_room_number, int Original_reservation_id, int Original_client_id, string Original_room_type, System.DateTime Original_date_in, System.DateTime Original_date_out) {
            return this.Update(room_number, client_id, room_type, date_in, date_out, Original_room_number, Original_reservation_id, Original_client_id, Original_room_type, Original_date_in, Original_date_out, Original_reservation_id);
        }
    }
