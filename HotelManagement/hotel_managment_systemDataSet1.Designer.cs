...
namespace HotelManagement {
    ...
    public partial class hotel_managment_systemDataSet1 : global::System.Data.DataSet {
        ...
        public partial class clientDataTable : global::System.Data.TypedTableBase<clientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public clientRow AddclientRow(string fullname, string email, string mobile_number) {
        ...
        public partial class clientRow : global::System.Data.DataRow {
            ...
            public string mobile_number {
                get {
                    return ((string)(this[this.tableclient.mobile_numberColumn]));
                }
                set {
                    this[this.tableclient.mobile_numberColumn] = value;
                }
            }
        }
...
namespace HotelManagement.hotel_managment_systemDataSet1TableAdapters {
    ...
    public partial class clientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[client] WHERE (([Id] = @Original_Id) AND ([fullname] = @Origin" +
                "al_fullname) AND ([email] = @Original_email) AND ([mobile_number] = @Original_mo" +
                "bile_number))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[client] ([fullname], [email], [mobile_number]) VALUES (@fullna" +
                "me, @email, @mobile_number);\r\nSELECT Id, fullname, email, mobile_number FROM cli" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[client] SET [fullname] = @fullname, [email] = @email, [mobile_number] = @mobile_number WHERE (([Id] = @Original_Id) AND ([fullname] = @Original_fullname) AND ([email] = @Original_email) AND ([mobile_number] = @Original_mobile_number));
SELECT Id, fullname, email, mobile_number FROM client WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, fullname, email, mobile_number FROM dbo.client";
        ...
        public virtual int Fill(hotel_managment_systemDataSet1.clientDataTable dataTable) {
        ...
        public virtual hotel_managment_systemDataSet1.clientDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            hotel_managment_systemDataSet1.clientDataTable dataTable = new hotel_managment_systemDataSet1.clientDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(hotel_managment_systemDataSet1.clientDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_fullname, string Original_email, string Original_mobile_number) {
            ...
            if ((Original_mobile_number == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_mobile_number));
            }
        ...
        public virtual int Insert(string fullname, string email, string mobile_number) {
            if ((fullname == null)) {
        ...
        public virtual int Update(string fullname, string email, string mobile_number, int Original_Id, string Original_fullname, string Original_email, string Original_mobile_number, int Id) {
            if ((fullname == null)) {
                throw new global::System.ArgumentNullException("fullname");
            }
            else {
            ...
            if ((Original_mobile_number == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_mobile_number));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fullname, string email, string mobile_number, int Original_Id, string Original_fullname, string Original_email, string Original_mobile_number) {
            return this.Update(fullname, email, mobile_number, Original_Id, Original_fullname, Original_email, Original_mobile_number, Original_Id);
        }
    }
